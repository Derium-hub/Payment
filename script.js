/* ==========================================
   EDIT BAGIAN INI SAJA UNTUK MENGUBAH METODE
   ========================================== */
const METHODS = [
    {
        name: "GoPay",
        holder: "Toko Online Resmi",
    ...
    },
    {
        ...
        qr: "https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=PEMBAYARAN_DIGITAL_DEMO",
